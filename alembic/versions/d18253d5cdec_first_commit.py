...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_articles_author'),
                    'articles', ['author'], unique=False)
    ...
    op.create_index(op.f('ix_categories_category'),
                    'categories', ['category'], unique=False)
    ...
    op.create_index(op.f('ix_skill_levels_id'),
                    'skill_levels', ['id'], unique=False)
    op.create_index(op.f('ix_skill_levels_level'),
                    'skill_levels', ['level'], unique=False)
